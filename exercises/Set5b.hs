...
allValues cond (Node val l r) = cond val && allValues cond l && allValues cond r
...
cull _ Empty = Empty
cull target (Node val l r)
    | val == target = Empty
    | otherwise = Node val (cull target l) (cull target r)
...
set _ _ Empty = Empty
set [] target (Node _ l r) = Node target l r
set (StepL : steps) target (Node val l r) = Node val (set steps target l) r
set (StepR : steps) target (Node val l r) = Node val l (set steps target r)
